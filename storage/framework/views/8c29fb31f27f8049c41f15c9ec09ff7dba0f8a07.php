        ...
        <div class="flex mt-[4.7rem] md:mt-0">
            ...
            <nav class="side-nav">
                <a href="" class="intro-x flex items-center pl-5 pt-4">
                    <img alt="Midone - HTML Admin Template" class="w-6" src="<?php echo e(asset('assets/dist/images/logo.svg')); ?>">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="">
                            ...
                            <li>
                                <a href="login.register" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                ...
                <div class="top-bar">
                            ...
                            <div class="notification-content__box dropdown-content">
                                ...
                                <div class="cursor-pointer relative flex items-center ">
                                    <div class="w-12 h-12 flex-none image-fit mr-1">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('assets/dist/images/profile-7.jpg')); ?>">
                                ...
                                <div class="cursor-pointer relative flex items-center mt-5">
                                    <div class="w-12 h-12 flex-none image-fit mr-1">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('assets/dist/images/profile-2.jpg')); ?>">
                                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                                    </div>
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                                ...
                                <div class="cursor-pointer relative flex items-center mt-5">
                                    <div class="w-12 h-12 flex-none image-fit mr-1">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('assets/dist/images/profile-5.jpg')); ?>">
                                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                                    </div>
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                                ...
                                <div class="cursor-pointer relative flex items-center mt-5">
                                    <div class="w-12 h-12 flex-none image-fit mr-1">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('assets/dist/images/profile-9.jpg')); ?>">
                                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                                    </div>
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                                ...
                                <div class="cursor-pointer relative flex items-center mt-5">
                                    <div class="w-12 h-12 flex-none image-fit mr-1">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('assets/dist/images/profile-1.jpg')); ?>">
                                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                                    </div>
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                            <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('assets/dist/images/profile-5.jpg')); ?>">
                        </div>
                    ...
                    <div class="col-span-12 2xl:col-span-9">
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 lg:col-span-6 mt-8">
                                ...
                                <div class="intro-y box p-5 mt-12 sm:mt-5">
                                    ...
                                    <div class="report-chart">
                                        <div class="h-[400px]">
                                            <canvas id="horizontal-bar-chart-widget">
                                                </canvas>
                                            </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
                                ...
                                <div class="intro-y box p-5 mt-5">
                                    <div class="mt-3">
                                        <div class="h-[390px]"> <canvas id="donut-chart-widget"></canvas> </div>
                                    </div>
                                    <div class="w-52 sm:w-auto mx-auto mt-8">
                                        <div class="flex items-center">
                                            <div class="w-2 h-2 bg-primary rounded-full mr-3"></div>
...
<?php /**PATH D:\peminjaman\peminjaman_bmn\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>