...
>>>>>>> cc0adc6d03c83a38619cc1fbeb920611ac198e02
            <!-- END: Side Menu -->
            <!-- BEGIN: Content -->
            <div class="content">
                <!-- BEGIN: Top Bar -->
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            {{-- <div class="col-span-12 xl:col-span-8 mt-6">
                                ...
                                <div class="intro-y box p-5 mt-12 sm:mt-5">
                                    ...
                                    <div class="report-maps mt-5 bg-slate-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="{{ asset('assets/dist/json/location.json') }}"></div>
                                </div>
                            </div>
                            <!-- END: Official Store -->
